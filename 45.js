...
let fname1 = "Sharif\hussain";
let fname2 = "Sharif\Hussain";
console.log(fname1);
console.log(fname2);
...
let Names = ["Sharif", "Hussain", "Fahad", "Shahzad"];
console.log(Names[0]);
console.log(Names[1]);
console.log(Names[2]);
console.log(Names[3]);
// 12.Greetings: Start with the array you used in Exercise 11, but instead of just printing each person’s name, print a message to them. The text of each message should be the same, but each message should be personalized with the person’s name. 
let names = ["Sharif", "Fahad", "Shahzad", "Hussain"];
...
let guestName = ["Sharif", "Fariz", "Fahad"];
