...
let firstName:string="Sharif Hussain";
...
let fname1:string = "Sharif\hussain";
let fname2:string = "Sharif\Hussain";
console.log(fname1);
console.log(fname2);
...
let Names:string[] = ["Sharif" , "Hussain" , "Fahad" , "Shahzad"]
console.log(Names[0]);
console.log(Names[1]);
console.log(Names[2]);
console.log(Names[3]);
...
let names:string[] = ["Sharif" , "Fahad" , "Shahzad" , "Hussain"];
...
let guestName:string[] = ["Sharif" , "Fariz", "Fahad"]
guestName.map((item)=>(
